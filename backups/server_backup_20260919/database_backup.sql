...
--
-- Current Database: `simple_website`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `simple_website` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `center_overview_banner` (
  ...
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'image' COMMENT '类型：image-图片，video-视频',
  `image_url` text COLLATE utf8mb4_unicode_ci COMMENT '图片路径（相对路径）',
  `video_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频路径（相对路径）',
  `video_url_external` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '外部视频URL',
...
INSERT INTO `center_overview_banner` VALUES (1,'video',NULL,'http://116.62.13.27:8084/upload/20251202/1764682579243_51773f0c.mp4',NULL,'2025-12-02 13:36:19','2025-12-02 13:36:27',1,'2025-12-02 13:36:27'),(2,'video',NULL,'http://116.62.13.27:8084/upload/20251202/1764682586594_cf01253b.mp4',NULL,'2025-12-02 13:36:27','2025-12-02 13:36:27',0,NULL);
...
CREATE TABLE `center_overview_detail` (
  ...
  `background` text COLLATE utf8mb4_unicode_ci COMMENT '建设背景（HTML格式）',
  `overview` text COLLATE utf8mb4_unicode_ci COMMENT '现状概况（HTML格式）',
  `vision` text COLLATE utf8mb4_unicode_ci COMMENT '发展愿景（HTML格式）',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `center_overview_laboratory` (
  ...
  `image_url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片路径（相对路径）',
  `link` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '链接地址',
...
CREATE TABLE `center_overview_organization` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `role` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色名称，支持中文，如：主任、副主任、成员等',
...
CREATE TABLE `contents` (
  ...
  `title` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '内容标题',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '图文内容（HTML格式）',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `footer_basics` (
  ...
  `logo` text COLLATE utf8mb4_unicode_ci COMMENT 'Logo URL',
...
CREATE TABLE `footer_contacts` (
  ...
  `postcode` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邮编',
  ...
  `work_time` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工作时间',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `footer_links` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '链接名称',
  `url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '链接地址',
  `target` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT '_blank' COMMENT '打开方式：_self或_blank',
...
CREATE TABLE `home_announcements` (
  ...
  `description` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '公告描述',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '公告内容（HTML格式）',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'draft' COMMENT '状态：draft-草稿，published-已发布',
...
CREATE TABLE `home_banners` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `image_url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Banner图片路径（相对路径，如：upload/20251130/xxx.jpg）',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
INSERT INTO `home_banners` VALUES (3,'http://116.62.13.27:8084/upload/20251202/1764679802747_5f4bb268.jpg','2025-12-02 12:50:03','2025-12-05 08:00:05',1,'2025-12-05 08:00:05'),(4,'http://116.62.13.27:8084/upload/20251205/1764921730386_ba96f04c.jpg','2025-12-05 08:02:10','2026-01-08 09:01:02',1,'2026-01-08 09:01:02'),(5,'http://116.62.13.27:8084/upload/20260108/1767862872170_aeb03015.jpg','2026-01-08 09:01:12','2026-01-08 09:01:12',0,NULL);
...
CREATE TABLE `home_carousels` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `image` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '轮播图片路径（相对路径，如：upload/20251130/xxx.jpg）',
  `title` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '轮播图标题',
  `description` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '轮播图描述',
  `link` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '链接地址',
  `sort` int DEFAULT '0' COMMENT '排序',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `home_carousels` VALUES (1,'http://116.62.13.27:8084/upload/20251202/1764678842350_7d6c9516.jpg','11','','',0,'2025-12-02 12:34:02','2025-12-02 13:04:09',1,'2025-12-02 13:04:09'),(2,'http://116.62.13.27:8084/upload/20251202/1764681505238_d686a222.jpg','111','','',0,'2025-12-02 13:18:25','2025-12-02 13:24:45',1,'2025-12-02 13:24:45'),(3,'http://116.62.13.27:8084/upload/20251202/1764681576101_a1e7bbf9.jpg','111','','http://116.62.13.27:8085/detail/news/4?from=home',0,'2025-12-02 13:19:36','2026-01-08 08:05:54',1,'2026-01-08 08:05:54'),(4,'http://116.62.13.27:8084/upload/20260108/1767859582568_495cbea6.jpg','建筑学院迎接保卫处、设备处年底检查','','http://116.62.13.27:8085/detail/news/7?from=home',1,'2026-01-08 08:06:23','2026-01-08 08:06:23',0,NULL),(5,'http://116.62.13.27:8084/upload/20260108/1767859628112_0848dcc3.jpg','教学实验中心例会：实验教学体系讨论','','http://116.62.13.27:8085/detail/news/8?from=home',0,'2026-01-08 08:07:08','2026-01-08 08:07:08',0,NULL),(6,'http://116.62.13.27:8084/upload/20260323/1774242624736_8c16fd2c.jpg','把实验室建到建设一线 | 江苏省碳达峰碳中和科技创新专项资金项目启动会在苏州北站高铁枢纽建设现场召','','http://116.62.13.27:8085/detail/news/9?from=home',0,'2026-03-23 05:10:25','2026-03-23 05:11:05',0,NULL),(7,'http://116.62.13.27:8084/upload/20260403/1775205282902_47aecce8.jpg','筑木为亭，以构见心｜东南大学建筑学院校园凉亭木构装置搭建活动圆满完成','','http://116.62.13.27:8085/detail/news/11?from=home',0,'2026-04-03 08:34:43','2026-04-03 08:34:43',0,NULL),(8,'http://116.62.13.27:8084/upload/20260514/1778746287783_c7bfbd71.jpg','实验教学中心工作例会','2026年5月6日，实验教学中心主任王伟主持召开实验室工作例会','http://116.62.13.27:8085/detail/news/12?from=home',0,'2026-05-14 08:11:28','2026-05-14 08:13:17',0,NULL);
...
CREATE TABLE `home_news` (
  ...
  `description` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '新闻描述',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '新闻内容（HTML格式）',
...
CREATE TABLE `menus` (
  ...
  `page_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '页面类型：news-list, product-list, image-text, download-list',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `module_banners` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `category` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模块分类：experiment-teaching-实验教学，experiment-resources-实验资源，construction-results-建设成效，safety-management-安全管理',
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'image' COMMENT '类型：image-图片，video-视频',
  `image_url` text COLLATE utf8mb4_unicode_ci COMMENT '图片路径（相对路径）',
  `video_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频路径（相对路径）',
  `video_url_external` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '外部视频URL',
...
INSERT INTO `module_banners` VALUES (1,'experiment-teaching','image','http://116.62.13.27:8084/upload/20251202/1764683312211_76e28100.jpg',NULL,NULL,'2025-12-02 13:48:32','2025-12-02 13:48:50',1,'2025-12-02 13:48:50'),(2,'experiment-teaching','image',NULL,NULL,NULL,'2025-12-02 13:48:50','2026-01-08 09:07:45',1,'2026-01-08 09:07:45'),(3,'experiment-resources','image','http://116.62.13.27:8084/upload/20251202/1764683387800_3ed7ef17.jpg',NULL,NULL,'2025-12-02 13:49:48','2025-12-02 13:50:10',1,'2025-12-02 13:50:10'),(4,'experiment-resources','image','http://116.62.13.27:8084/upload/20251202/1764683428832_f21e8a01.jpg',NULL,NULL,'2025-12-02 13:50:29','2025-12-02 13:50:29',0,NULL),(5,'construction-results','image','http://116.62.13.27:8084/upload/20251202/1764683476838_3b4e49ae.jpg',NULL,NULL,'2025-12-02 13:51:17','2025-12-02 13:51:17',0,NULL),(6,'safety-management','image','http://116.62.13.27:8084/upload/20251202/1764683522608_4d680e04.jpg',NULL,NULL,'2025-12-02 13:52:03','2025-12-02 13:52:03',0,NULL),(7,'experiment-teaching','image','http://116.62.13.27:8084/upload/20260108/1767863264577_e2a3fd7f.jpg',NULL,NULL,'2026-01-08 09:07:45','2026-01-08 09:07:45',0,NULL);
...
CREATE TABLE `module_downloads` (
  ...
  `file_url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文件URL',
  `category` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分类',
  `file_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '文件类型：pdf, doc, xls, other',
...
INSERT INTO `module_downloads` VALUES (1,23,'东南大学景观学系工作室安全管理.docx','http://116.62.13.27:8084/upload/20251202/1764685967040_97ea5a90.docx',NULL,'doc',18164,0,'2025-12-02 14:32:47','2025-12-02 14:32:47',0,NULL),(2,23,'关于推荐2026年硕士研究生入学考试监考人员的通知.pdf','http://116.62.13.27:8084/upload/20251202/1764686116591_d8459667.pdf',NULL,'pdf',147107,0,'2025-12-02 14:35:17','2025-12-02 14:35:23',1,'2025-12-02 14:35:23'),(3,23,'关于表彰东南大学2025年本科招生工作先进集体和个人的决定.pdf','http://116.62.13.27:8084/upload/20251202/1764686150463_36190f32.pdf',NULL,'pdf',243535,0,'2025-12-02 14:35:50','2025-12-09 14:38:39',1,'2025-12-09 14:38:39'),(4,23,'建筑学院学生实验室安全准入报告表.docx','http://116.62.13.27:8084/upload/20260323/1774242077016_2f754fe8.pdf','实验必备申请文件','doc',195524,0,'2025-12-09 14:39:36','2026-03-23 05:01:17',0,NULL),(5,23,'关于深刻汲取重庆大学实验室安全事故教训 立即开展实验室安全自查自纠的紧急通知','http://116.62.13.27:8084/upload/20260323/1774242031703_f94c0315.pdf','会议通知','pdf',195524,0,'2026-03-23 05:00:32','2026-03-23 05:00:32',0,NULL);
...
CREATE TABLE `module_products` (
  ...
  `image` text COLLATE utf8mb4_unicode_ci COMMENT '产品图片URL',
  `category` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT
-23 03:21:17','2026-03-23 03:21:17',0,NULL),(12,24,'变位制造系统','http://116.62.13.27:8084/upload/20260323/1774236117144_66dcc4fd.jpg','','','https://dxyq.seu.edu.cn/detail.action?equipDetail=true&id=ff80808165e76eca01665ceae18412d9','2026-03-23 03:21:57','2026-03-23 03:21:57',0,NULL),(13,24,'工业机器人','http://116.62.13.27:8084/upload/20260323/1774236150722_c45bd904.jpg','','','https://dxyq.seu.edu.cn/detail.action?equipDetail=true&id=ff80808165e76eca01665ce7c2e812d7','2026-03-23 03:22:31','2026-03-23 03:22:31',0,NULL);
...
CREATE TABLE `popular_science_activities` (
  ...
  `cover` text COLLATE utf8mb4_unicode_ci COMMENT '封面图片URL',
  `location` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '活动地点',
  `start_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '活动内容（HTML格式）',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'draft' COMMENT '状态：draft-草稿，published-已发布',
  `publish_time` datetime DEFAULT NULL COMMENT '发布时间',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `popular_science_banners` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `image_url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Banner图片URL',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint(1) NOT NULL DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
...
INSERT INTO `popular_science_banners` VALUES (1,'http://116.62.13.27:8084/upload/20251202/1764683561101_494628bf.jpg','2025-12-02 13:52:41','2025-12-02 13:52:41',0,NULL);
...
CREATE TABLE `popular_science_carousels` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `image` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '轮播图片URL',
  `title` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '轮播图标题',
  `link` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '链接地址',
  `sort` int DEFAULT '0' COMMENT '排序',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `popular_science_carousels` VALUES (1,'http://116.62.13.27:8084/upload/20251202/1764683833196_afee96c8.jpg','2025东南大学-皇家墨尔本理工国际机器人建造先锋营学员参观智能建造实验室','',0,'2025-12-02 13:57:13','2025-12-02 13:58:31',1,'2025-12-02 13:58:31'),(2,'/upload/20251202/1764683833196_afee96c8.jpg','2025东南大学-皇家墨尔本理工国际机器人建造先锋营学员参观智能建造实验室','',0,'2025-12-02 13:58:31','2025-12-02 13:59:12',1,'2025-12-02 13:59:12'),(3,'/upload/20251202/1764683833196_afee96c8.jpg','2025东南大学-皇家墨尔本理工国际机器人建造先锋营学员参观智能建造实验室','',0,'2025-12-02 13:59:12','2025-12-02 13:59:12',0,NULL),(4,'http://116.62.13.27:8084/upload/20251202/1764683951838_210783f3.jpg','设计基础实训实验室接待中欧暑期工作营学员','',0,'2025-12-02 13:59:12','2025-12-02 13:59:12',0,NULL);
...
CREATE TABLE `popular_science_videos` (
  ...
  `cover` text COLLATE utf8mb4_unicode_ci COMMENT '封面图片URL',
  `video_url` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '视频URL',
  `duration` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '视频时长',
...
INSERT INTO `system_config` VALUES (1,'base_url','http://116.62.13.27:8084','系统基础URL，用于拼接文件访问的完整地址','2025-12-02 20:25:40','2025-12-02 20:30:19');
...
--
-- Dumping routines for database 'simple_website'
--
...
-- Dump completed on 2026-09-19 22:56:44
